...
class Notification {
  ...
  companion object {
    ...
    fun sendNotification(context: Context) {
      ...
      val resources = manager.getResourcesForApplication("io.flutter.plugins.scheduler_example")
      val resId = resources.getIdentifier("launch_background", "drawable", "io.flutter.plugins.scheduler_example")

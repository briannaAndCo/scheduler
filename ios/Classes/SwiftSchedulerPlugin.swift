...
public class SwiftSchedulerPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        switch call.method {
        case "SchedulerPlugin.scheduleNotification":
        ...
        case "SchedulerPlugin.cancelNotification":
            cancelNotification()
        case "SchedulerPlugin.rescheduleCurrentNotification":
    ...
    func rescheduleCurrentNotification() {
        UNUserNotificationCenter.current().getPendingNotificationRequests(completionHandler: { notifications in
